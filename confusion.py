...
class ConfusionMatrix(object):
    ...
    def summary(self):
        ...
        for i in range(self.num_classes):
            ...
            F1_score = round(((Precision * Recall) / (Precision + Recall)) * 2, 4) if Precision + Recall != 0 else 0.
            table.add_row([self.labels[i], Accuracy,Precision, Recall, Specificity, F1_score])
        print(table)
...
if __name__ == '__main__':
    ...
    data_root = 'D:/'
    image_path = os.path.join(data_root, "oct dataset", "processed OCT2017")
    ...
    # model = mymodel(im_height=im_height, im_width=im_width, num_classes=4)
    model = mymodel(im_height=im_height, im_width=im_width)
    pre_weights_path = 'D:/pycharm/project/new model/save_weights/mymodel.h5'
